...
fun main(){
  ...
  /*  println(box1.volume)
    ...
    */
    ...
    /*
    *  there are two types of constructor primary constructor and secondary constructor
    *   you can define as many init {} block as you want but it's an recommended way to declare an single init block
    *   after that you can define secondary constructor
    *
    *   class Box(
    *           // primary constructor
    *   ){
    ...
    *   }
    *
    *   // if you have visibility specifier the use the constructor keyword for example
